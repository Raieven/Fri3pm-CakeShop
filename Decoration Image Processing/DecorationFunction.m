...
function [blockOrder, leftOverBlocks] = your_decoration_function(cake, conveyor)
    global Decor;
    ...
    %         sprintf('yellowCakeShape: %d\n', yellowCakeShape)
        ...
        if (i > 1)
            if (blockOrder(Decor.blockOrderCounter,4) ~= 0 && blockOrder(Decor.blockOrderCounter,5) ~= 0 &&...
                    blockOrder(Decor.blockOrderCounter,6) ~= 0)
                % increments the variable that cycles throught the orderBlocks matrix
                Decor.blockOrderCounter = Decor.blockOrderCounter + 1;
            else
                %it doesnt increment, thus overwriting what we just had, so it doesnt have any zero values        
            end
        end
    end
    j = 1;
    for i = 1:size(detectedConvBlocksCentres,1)
        if (detectedConvBlocksCentres(i,1) ~= -100)
            ...
            leftOverBlocks(j,4) = 671;
            leftOverBlocks(j,5) = 486;
    ...
    %     Circle = 1, Diamond = 2, Star = 3, Clover = 4, Shuriken = 5, Square = 6
        if ((BP.Area >= 1020 && BP.Area <= 1450) && (BP.Solidity >= 0.92 && BP.Solidity <= 1 ) && ...
                (BP.Perimeter >= 128 && BP.Perimeter <= 170) && (BP.EquivDiameter >= 35 && BP.EquivDiameter <= 44) &&...
                (BP.MinorAxisLength >= 35 && BP.MinorAxisLength <= 45)&&(BP.MajorAxisLength >= 36 && BP.MajorAxisLength <= 45)) %(BP.Eccentricity >= 0.17 && BP.Eccentricity <= 0.42) 
                cakeShape = 1;
        elseif((BP.Area >= 924 && BP.Area <= 902) && (BP.Solidity >= 0.83 && BP.Solidity <= 0.95 ) && ...
            ...
            cakeShape = 2;
        elseif ((BP.Area >= 420 && BP.Area <= 822) && (BP.Solidity >= 0.57 && BP.Solidity <= 0.82 ) && ...
                (BP.Perimeter >= 110 && BP.Perimeter <= 208) && (BP.EquivDiameter >= 22 && BP.EquivDiameter <= 33) &&...
                (BP.MinorAxisLength >= 21 && BP.MinorAxisLength <= 34) && (BP.MajorAxisLength >= 25 && BP.MajorAxisLength <= 35.5))%(BP.Eccentricity >= 0.25 && BP.Eccentricity <= 0.57)
            cakeShape = 3;
        elseif ((BP.Area >= 545 && BP.Area <= 1200) && (BP.Solidity >= 0.50 && BP.Solidity <= 0.85 ) && ...
                (BP.Perimeter >= 150 && BP.Perimeter <= 254) && (BP.EquivDiameter >= 25 && BP.EquivDiameter <= 40) &&...
                (BP.MinorAxisLength >= 27 && BP.MinorAxisLength <= 41) && (BP.MajorAxisLength >= 28 && BP.MajorAxisLength <= 42)) %(BP.Eccentricity >= 0.28 && BP.Eccentricity <= 0.37)
            cakeShape =  4;
        elseif ((BP.Area >= 454 && BP.Area <= 919) && (BP.Solidity >= 0.47 && BP.Solidity <= 0.58 ) && ...
            ...
            cakeShape = 5;
        elseif ((BP.Area >= 839 && BP.Area <= 1095) && (BP.Solidity >= 0.88 && BP.Solidity <= 0.94) && ...
                (BP.Perimeter >= 115 && BP.Perimeter <= 150) && (BP.EquivDiameter >= 31 && BP.EquivDiameter <= 38) &&...
                (BP.MinorAxisLength >= 30 && BP.MinorAxisLength <= 38) && (BP.MajorAxisLength >= 33 && BP.MajorAxisLength <= 39)) %(BP.Eccentricity >= 0.24 && BP.Eccentricity <= 0.44)
            cakeShape = 6;
        else
            cakeShape = 7;
        end
    ...
    %     Square = 6
        ...
        elseif ((BP.Area >= 420 && BP.Area <= 773) && (BP.Solidity >= 0.57 && BP.Solidity <= 0.82 ) && ...
                (BP.Perimeter >= 110 && BP.Perimeter <= 168) && (BP.EquivDiameter >= 22 && BP.EquivDiameter <= 32) &&...
            ...
            cakeShape = 3;
        elseif ((BP.Area >= 778 && BP.Area <= 1250) && (BP.Solidity >= 0.70 && BP.Solidity <= 0.87 ) && ...
                (BP.Perimeter >= 139 && BP.Perimeter <= 221) && (BP.EquivDiameter >= 30 && BP.EquivDiameter <= 40) &&...
                (BP.MinorAxisLength >= 33 && BP.MinorAxisLength <= 41) && (BP.MajorAxisLength >= 35 && BP.MajorAxisLength <= 45)) %(BP.Eccentricity >= 0.28 && BP.Eccentricity <= 0.37)
            cakeShape =  4;
        elseif ((BP.Area >= 402 && BP.Area <= 1024) && (BP.Solidity >= 0.47 && BP.Solidity <= 0.7 ) && ...
    ...
    %     Square = 6
        if ((BP.Area >= 1334 && BP.Area <= 1450) && (BP.Solidity >= 0.90 && BP.Solidity <= 0.98 ) && ...
                ...
                cakeShape = 1;
        elseif((BP.Area >= 932 && BP.Area <= 1140) && (BP.Solidity >= 0.91 && BP.Solidity <= 0.97 ) && ...
                (BP.Perimeter >= 115 && BP.Perimeter <= 146) && (BP.EquivDiameter >= 33 && BP.EquivDiameter <= 39) &&...
            ...
            cakeShape = 2;
        elseif ((BP.Area >= 459 && BP.Area <= 888) && (BP.Solidity >= 0.50 && BP.Solidity <= 0.70 ) && ...
                (BP.Perimeter >= 126 && BP.Perimeter <= 230) && (BP.EquivDiameter >= 23 && BP.EquivDiameter <= 34) &&...
                (BP.MinorAxisLength >= 24 && BP.MinorAxisLength <= 39) && (BP.MajorAxisLength >= 27 && BP.MajorAxisLength <= 42) &&...
                BP.Extent > 0.40)%(BP.Eccentricity >= 0.25 && BP.Eccentricity <= 0.57)
            cakeShape = 3;
        elseif ((BP.Area >= 860 && BP.Area <= 1218) && (BP.Solidity >= 0.76 && BP.Solidity <= 0.83 ) && ...
                (BP.Perimeter >= 150 && BP.Perimeter <= 199) && (BP.EquivDiameter >= 33 && BP.EquivDiameter <= 40) &&...
            ...
            cakeShape =  4;
        elseif ((BP.Area >= 530 && BP.Area <= 968) && (BP.Solidity >= 0.28 && BP.Solidity <= 0.57 ) && ...
                (BP.Perimeter >= 145 && BP.Perimeter <= 210) && (BP.EquivDiameter >= 25 && BP.EquivDiameter <= 37) &&...
                (BP.MinorAxisLength >= 30 && BP.MinorAxisLength <= 40) && (BP.MajorAxisLength >= 31 && BP.MajorAxisLength <= 42)) %(BP.Eccentricity >= 0.38 && BP.Eccentricity <= 0.55)
            cakeShape = 5;
        elseif ((BP.Area >= 800 && BP.Area <= 1090) && (BP.Solidity >= 0.85 && BP.Solidity <= 0.98) && ...
                (BP.Perimeter >= 120 && BP.Perimeter <= 170) && (BP.EquivDiameter >= 31 && BP.EquivDiameter <= 38) &&...
                (BP.MinorAxisLength >= 31 && BP.MinorAxisLength <= 39) && (BP.MajorAxisLength >= 32 && BP.MajorAxisLength <= 39)) %(BP.Eccentricity >= 0.24 && BP.Eccentricity <= 0.44)
            cakeShape = 6;
        else
            cakeShape = 7;
        end
    ...
    %     Square = 6
       if ((BP.Area >= 1223 && BP.Area <= 1274) && (BP.Solidity >= 0.82 && BP.Solidity <= 1 ) && ...
        ...
        elseif((BP.Area >= 935 && BP.Area <= 976) && (BP.Solidity >= 0.79 && BP.Solidity <= 1 ) && ...
            ...
            cakeShape = 2;
        elseif ((BP.Area >= 567 && BP.Area <= 800) && (BP.Solidity >= 0.42 && BP.Solidity <= 0.76 ) && ...
                (BP.Perimeter >= 163 && BP.Perimeter <= 271) && (BP.EquivDiameter >= 25 && BP.EquivDiameter <= 32) &&...
                (BP.MinorAxisLength >= 26 && BP.MinorAxisLength <= 35) && (BP.MajorAxisLength >= 28 && BP.MajorAxisLength <= 38))%(BP.Eccentricity >= 0.25 && BP.Eccentricity <= 0.57)
            cakeShape = 3;
        elseif ((BP.Area >= 956.5 && BP.Area <= 1040) && (BP.Solidity >= 0.63 && BP.Solidity <= 0.96 ) && ...
            ...
            cakeShape =  4;
        elseif ((BP.Area >= 621 && BP.Area <= 870) && (BP.Solidity >= 0.35 && BP.Solidity <= 0.71 ) && ...
                (BP.Perimeter >= 146 && BP.Perimeter <= 213) && (BP.EquivDiameter >= 26 && BP.EquivDiameter <= 35) &&...
                (BP.MinorAxisLength >= 32 && BP.MinorAxisLength <= 38) && (BP.MajorAxisLength >= 32 && BP.MajorAxisLength <= 44)) %(BP.Eccentricity >= 0.38 && BP.Eccentricity <= 0.55)
            cakeShape = 5;
        elseif ((BP.Area >= 921 && BP.Area <= 1016) && (BP.Solidity >= 0.79 && BP.Solidity <= 0.98) && ...
                (BP.Perimeter >= 114 && BP.Perimeter <= 129) && (BP.EquivDiameter >= 32 && BP.EquivDiameter <= 37) &&...
                (BP.MinorAxisLength >= 34 && BP.MinorAxisLength <= 37) && (BP.MajorAxisLength >= 33 && BP.MajorAxisLength <= 38)) %(BP.Eccentricity >= 0.24 && BP.Eccentricity <= 0.44)
            cakeShape = 6;
       else
            cakeShape = 7;
       end
    ...
    %     Square = 6
        ...
        elseif ((CB.Area >= 698 && CB.Area <= 827.5) && (CB.Solidity >= 0.75 && CB.Solidity <= 0.97 ) && ...
            ...
            convShape = 2;
        elseif ((CB.Area >= 257 && CB.Area <= 625) && (CB.Solidity >= 0.45 && CB.Solidity <= 0.96 ) && ...
                (CB.Perimeter >= 81 && CB.Perimeter <= 175) && (CB.EquivDiameter >= 16 && CB.EquivDiameter <= 29) &&...
                (CB.MinorAxisLength >= 17 && CB.MinorAxisLength <= 30) && (CB.MajorAxisLength >= 19 && CB.MajorAxisLength <= 31)) %(CB.Eccentricity >= 0.15 && CB.Eccentricity <= 0.41) 
            convShape = 3;
        elseif ((CB.Area >= 758 && CB.Area <= 947) && (CB.Solidity >= 0.63 && CB.Solidity <= 0.99 ) && ...
                (CB.Perimeter >= 125 && CB.Perimeter <= 177) && (CB.EquivDiameter >= 29 && CB.EquivDiameter <= 36) &&...
                (CB.MinorAxisLength >= 33 && CB.MinorAxisLength <= 36) && (CB.MajorAxisLength >= 32 && CB.MajorAxisLength <= 40)) %(CB.Eccentricity >= 0.15 && CB.Eccentricity <= 0.3) 
            convShape =  4;
    ...
    %     Square = 6
        ...
        elseif ((CB.Area >= 608 && CB.Area <= 1102) && (CB.Solidity >= 0.84 && CB.Solidity <= 0.97 ) && ...
            ...
            convShape = 2;
        elseif ((CB.Area >= 323.5 && CB.Area <= 593) && (CB.Solidity >= 0.61 && CB.Solidity <= 0.78 ) && ...
                (CB.Perimeter >= 87 && CB.Perimeter <= 164) && (CB.EquivDiameter >= 18 && CB.EquivDiameter <= 28) &&...
                (CB.MinorAxisLength >= 20 && CB.MinorAxisLength <= 30) && (CB.MajorAxisLength >= 20 && CB.MajorAxisLength <= 31)) %(CB.Eccentricity >= 0.15 && CB.Eccentricity <= 0.41) 
            convShape = 3;
    ...
    %     Square = 6
        ...
        elseif ((CB.Area >= 629 && CB.Area <= 786) && (CB.Solidity >= 0.71 && CB.Solidity <= 0.83 ) && ...
                ...
                (CB.MinorAxisLength >= 29 && CB.MinorAxisLength <= 34) && (CB.MajorAxisLength >= 30 && CB.MajorAxisLength <= 36)) %(CB.Eccentricity >= 0.15 && CB.Eccentricity <= 0.41) 
            convShape =  4;
...
%% read in files //======= should be getting from camera capture =======//
    ...
    cake = imread('D:\MTRN4230\COMPLETEDISHHHHCODEEEE\Proper_Pics\Patterns\Pattern1.jpg');
    conveyor = imread('D:\MTRN4230\COMPLETEDISHHHHCODEEEE\Proper_Pics\conveyor__08_14_21_35_41.jpg');
...
%      a = load('cameraParams3');
    a = load('cameraParams_table.mat');
    ...
    [tableRotationMatrix,tableTranslationVector] = extrinsics(imagePoints,worldPoints,a.mainCameraParams);
    ...
    for i = 1:size(detectedCakeBlocks,1)
        ...
        convOrientation = 0;
        %put the centres of the first cake block in the matricies
        cakeWorldCentres = pointsToWorld(a.mainCameraParams, tableRotationMatrix, tableTranslationVector, [detectedCakeBlocksCentres(i,1), detectedCakeBlocksCentres(i,2)]);
        ...
        blockOrderMaintenance(blockOrderCounter,1) = detectedCakeBlocksCentres(i,1);
        blockOrderMaintenance(blockOrderCounter,2) = detectedCakeBlocksCentres(i,2);
        ...
        blockOrderMaintenance(blockOrderCounter,5) = points(1);
        blockOrderMaintenance(blockOrderCounter,6) = points(2);
        blockOrderMaintenance(blockOrderCounter,7) = points(3);
        blockOrderMaintenance(blockOrderCounter,8) = points(4);
    ...
    %         sprintf('redCakeShape: %d\n', redCakeShape)
            [matchedIndex,convOrientation,points] = matchWithConveyor(blockColourFlag,redCakeShape, redConvBlockIndex, ...
                                                            detectedConvBlocks, conveyor,block,blockOrderMaintenance,blockOrderCounter);
            if matchedIndex ~= 155
                ...
                blockOrderMaintenance(blockOrderCounter,3) = detectedConvBlocksCentres(matchedIndex,1);
                blockOrderMaintenance(blockOrderCounter,4) = detectedConvBlocksCentres(matchedIndex,2);
                %sets the found block on conveyor to a really large value to not
                %consider it anyomore, matchWithConveyor does not consider 255
                idx = find(redConvBlockIndex == matchedIndex);
                redConvBlockIndex(idx) = 255;
    ...
    %         sprintf('yellowCakeShape: %d\n', yellowCakeShape)
        ...
        blockOrderMaintenance(blockOrderCounter,9) = points(1);
        blockOrderMaintenance(blockOrderCounter,10) = points(2);
        blockOrderMaintenance(blockOrderCounter,11) = points(3);
        blockOrderMaintenance(blockOrderCounter,12) = points(4);
        % increments the variable that cycles throught the orderBlocks matrix
    ...
    for i = 1:size(blockOrder,1)
        ...
        p2 = [blockOrderMaintenance(i,1) - xShift, blockOrderMaintenance(i,2) - yShift];
        D = p1 - p2;
    ...
    figure(6); axis;
    imshow(conveyor); hold on;
    % for j = 1:size(blockOrderMaintenance,1)
    %     for i = 1:size(detectedConvBlocks,1)
    %         if (detectedConvBlocksCentres(i,1) == blockOrderMaintenance(j,3) && ...
    %                 detectedConvBlocksCentres(i,2) == blockOrderMaintenance(j,3))
    %             bb = detectedConvBlocks(i,:);
    %             rectangle('position',bb,'edgecolor','g','linewidth',2);
    %         end
    %     end
    % end
    for i = 1:size(blockOrder,1)
        ...
        p2 = [blockOrderMaintenance(i,3) - xShift, blockOrderMaintenance(i,4) - yShift];
        D = p1 - p2;
        q = quiver( p1(1), p1(2), D(1), D(2), 0,'linewidth', 2);
        q.Color = 'red'; q.ShowArrowHead = 'on';
        text(p1(1),p1(2)-20, sprintf('Block %d',i),'Color','red')
