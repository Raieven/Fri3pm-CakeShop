...
function [blockOrder,leftOverBlocks,cakeBlockUnmatchedIndex,...
    ...
    if Decor.UnmatchedBlocksFlag == 0
        cake = imcrop(cake,[519.5 253.5 559 553]);
    ...
    %     Shuriken = 5
    %     Square = 6
        if ((BP.Area >= 1096 && BP.Area <= 1292) && (BP.Solidity >= 0.93 && BP.Solidity <= 1 ) && ...
                (BP.Perimeter >= 123 && BP.Perimeter <= 144) && (BP.EquivDiameter >= 35 && BP.EquivDiameter <= 42) &&...
        ...
        elseif ((BP.Area >= 420 && BP.Area <= 773) && (BP.Solidity >= 0.57 && BP.Solidity <= 0.82 ) && ...
                (BP.Perimeter >= 110 && BP.Perimeter <= 179) && (BP.EquivDiameter >= 22 && BP.EquivDiameter <= 31) &&...
        ...
        elseif ((BP.Area >= 545 && BP.Area <= 1136) && (BP.Solidity >= 0.50 && BP.Solidity <= 0.85 ) && ...
                (BP.Perimeter >= 150 && BP.Perimeter <= 246) && (BP.EquivDiameter >= 25 && BP.EquivDiameter <= 39) &&...
        ...
        elseif ((BP.Area >= 454 && BP.Area <= 919) && (BP.Solidity >= 0.47 && BP.Solidity <= 0.58 ) && ...
            ...
            cakeShape = 5;
        elseif ((BP.Area >= 839 && BP.Area <= 1006) && (BP.Solidity >= 0.88 && BP.Solidity <= 0.96) && ...
                (BP.Perimeter >= 115 && BP.Perimeter <= 150) && (BP.EquivDiameter >= 31 && BP.EquivDiameter <= 36) &&...
                (BP.MinorAxisLength >= 30 && BP.MinorAxisLength <= 37) && (BP.MajorAxisLength >= 33 && BP.MajorAxisLength <= 37.5)) %(BP.Eccentricity >= 0.24 && BP.Eccentricity <= 0.44)
            cakeShape = 6;
        else
    ...
    %     Square = 6
        ...
        elseif((BP.Area >= 819 && BP.Area <= 1045) && (BP.Solidity >= 0.83 && BP.Solidity <= 0.93 ) && ...
                ...
                (BP.MinorAxisLength >= 32 && BP.MinorAxisLength <= 40) && (BP.MajorAxisLength >= 32 && BP.MajorAxisLength <= 40)&&...
                BP.Extent <0.57) %(BP.Eccentricity >= 0.10 && BP.Eccentricity <= 0.38)
            cakeShape = 2;
        elseif ((BP.Area >= 420 && BP.Area <= 868) && (BP.Solidity >= 0.57 && BP.Solidity <= 0.82 ) && ...
                ...
                BP.Extent >= 0.4 && BP.Extent <= 0.50)%(BP.Eccentricity >= 0.25 && BP.Eccentricity <= 0.57)
            cakeShape = 3;
        elseif ((BP.Area >= 778 && BP.Area <= 1176) && (BP.Solidity >= 0.70 && BP.Solidity <= 0.87 ) && ...
                (BP.Perimeter >= 136 && BP.Perimeter <= 200) && (BP.EquivDiameter >= 30 && BP.EquivDiameter <= 40) &&...
    ...
    %     Shuriken = 5
    %     Square = 6
        if ((BP.Area >= 1130 && BP.Area <= 1450) && (BP.Solidity >= 0.90 && BP.Solidity <= 0.99 ) && ...
                (BP.Perimeter >= 117 && BP.Perimeter <= 175) && (BP.EquivDiameter >= 36 && BP.EquivDiameter <= 44) &&...
        ...
        elseif((BP.Area >= 932 && BP.Area <= 1108) && (BP.Solidity >= 0.91 && BP.Solidity <= 0.97 ) && ...
            ...
            cakeShape = 2;
        elseif ((BP.Area >= 547 && BP.Area <= 888) && (BP.Solidity >= 0.58 && BP.Solidity <= 0.70 ) && ...
                (BP.Perimeter >= 156 && BP.Perimeter <= 230) && (BP.EquivDiameter >= 26 && BP.EquivDiameter <= 34) &&...
                (BP.MinorAxisLength >= 27.5 && BP.MinorAxisLength <= 39) && (BP.MajorAxisLength >= 29 && BP.MajorAxisLength <= 42))%(BP.Eccentricity >= 0.25 && BP.Eccentricity <= 0.57)
            cakeShape = 3;
        elseif ((BP.Area >= 835 && BP.Area <= 1221) && (BP.Solidity >= 0.78 && BP.Solidity <= 0.86 ) && ...
            ...
            cakeShape =  4;
        elseif ((BP.Area >= 590 && BP.Area <= 968) && (BP.Solidity >= 0.28 && BP.Solidity <= 0.66 ) && ...
                (BP.Perimeter >= 146 && BP.Perimeter <= 210) && (BP.EquivDiameter >= 27 && BP.EquivDiameter <= 37) &&...
                (BP.MinorAxisLength >= 31.7 && BP.MinorAxisLength <= 40) && (BP.MajorAxisLength >= 34 && BP.MajorAxisLength <= 42)) %(BP.Eccentricity >= 0.38 && BP.Eccentricity <= 0.55)
            cakeShape = 5;
        elseif ((BP.Area >= 802 && BP.Area <= 1079) && (BP.Solidity >= 0.85 && BP.Solidity <= 1) && ...
                (BP.Perimeter >= 107.5 && BP.Perimeter <= 170) && (BP.EquivDiameter >= 31 && BP.EquivDiameter <= 38) &&...
                (BP.MinorAxisLength >= 32 && BP.MinorAxisLength <= 39) && (BP.MajorAxisLength >= 32.5 && BP.MajorAxisLength <= 39)) %(BP.Eccentricity >= 0.24 && BP.Eccentricity <= 0.44)
            cakeShape = 6;
        else
            disp("Shape Was Not Identified");
            cakeShape = 7;
    ...
    %     Square = 6
       if ((BP.Area >= 1130 && BP.Area <= 1274) && (BP.Solidity >= 0.82 && BP.Solidity <= 1 ) && ...
        ...
        elseif((BP.Area >= 935 && BP.Area <= 976) && (BP.Solidity >= 0.79 && BP.Solidity <= 1 ) && ...
            ...
            cakeShape = 2;
        elseif ((BP.Area >= 515 && BP.Area <= 615) && (BP.Solidity >= 0.42 && BP.Solidity <= 0.76 ) && ...
        ...
        elseif ((BP.Area >= 878 && BP.Area <= 1001) && (BP.Solidity >= 0.63 && BP.Solidity <= 0.96 ) && ...
            ...
            cakeShape =  4;
        elseif ((BP.Area >= 545 && BP.Area <= 636) && (BP.Solidity >= 0.35 && BP.Solidity <= 0.71 ) && ...
                (BP.Perimeter >= 141 && BP.Perimeter <= 156) && (BP.EquivDiameter >= 26 && BP.EquivDiameter <= 30) &&...
            ...
            cakeShape = 5;
        elseif ((BP.Area >= 790 && BP.Area <= 980) && (BP.Solidity >= 0.79 && BP.Solidity <= 1) && ...
